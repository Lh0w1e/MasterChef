...
public class MultipleChoiceQuiz extends AppCompatActivity {
    ...
    private void displayInstructionDialog() {
        ...
        custom_view = layoutInflater.inflate(R.layout.multiple_choice_instruction, null);

        customBtnOk = (Button) custom_view.findViewById(R.id.custom_multiplechoice_btn_ok);
        ...
        customBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MultipleChoiceQuiz.this, Constants.THIS_FUNCTION_IS_UNDER_CONSTRUCTION, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
