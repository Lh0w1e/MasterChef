...
public class FavoritesModel {
    ...
    /*public FavoritesModel(int recipe_id, String recipe_name, String recipe_category,
                          String recipe_description, String recipe_number_of_serving,
                          String recipe_ingredients, String recipe_cooking_procedure,
                          Bitmap recipe_image) {
    ...
    public FavoritesModel(int recipe_id, String recipe_name, String recipe_category,
        ...
        this.setRecipe_category(recipe_category);
        this.setRecipe_description(recipe_description);
        this.setRecipe_number_of_serving(recipe_number_of_serving);
        this.setRecipe_ingredients(recipe_ingredients);
        this.setRecipe_cooking_procedure(recipe_cooking_procedure);
        this.setRecipe_image(recipe_image);
    }
